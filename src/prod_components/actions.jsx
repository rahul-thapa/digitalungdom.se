...
import {
 faStar, faComment, faTrashAlt, faFlag 
...
function Actions({
 dispatch, remove, report, id, link, isAuthor, like, replied, likes, liked, replies 
}) {
  ...
  style={{ cursor: 'pointer' }}
			>
  <FontAwesomeIcon color={isStarClicked ? 'gold' : 'lightgrey'} icon={faStar} /> 
{' '}
{likes}
   </span>
  ...
  style={{ cursor: 'pointer' }}
			>
  <FontAwesomeIcon color="lightgrey" icon={faComment} /> 
{' '}
{replies}
   </span>
  {
